 ...
 */
public class Zerch2 extends robocode.AdvancedRobot
{
  ...
  double enemyExtrapolatedAbsoluteBearing;
    ...
    public void run() {
      ...
      while(true) {
            ...
            setAhead(250);
            setTurnGunRightRadians(Utils.normalRelativeAngle(gunTargetHeading - getGunHeadingRadians()));
    ...
    public void onScannedRobot(ScannedRobotEvent e) {
      ...
      gunTargetHeading = enemyAbsoluteAngle;
